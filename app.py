...
if st.button("Calculate Eligibility"):
    ...
    # -----------------------------
    # FINAL ELIGIBILITY (CORE LOGIC)
    # -----------------------------

    asset_limit = asset_value * (1 - equity_pct / 100) if equity_allowed else cap

    approved = min(max_loan_dbr, cap, asset_limit)
